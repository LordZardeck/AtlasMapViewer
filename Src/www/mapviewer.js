...
class EntityMarker extends React.Component {
    ...
    add() {
        this.marker = createEntityMarker(this.props.info, this.props.map, this.props.markerColor)
...
class WorldMap extends React.Component {
    ...
    render() {
        const {entities, tribes, commandMarker, shipPath, color, onCancelCommand} = this.props
        ...
        return (
            <div id="worldmap">
                {/*{Object.keys(entities).map(id => {*/}
                    ...
                    {/*if(tribes[info.TribeID] !== void(0)) {*/}
                        {/*markerColor = tribes[info.TribeID].Color;*/}
                    {/*}*/}
...
function createEntityMarker(info, map, tribeColor) {
    ...
    render() {
        ...
        return (
            <div id="Legend" className="info legend">
                {Object.keys(tribes).map(id => {
                    return (<div key={id}><i style={{background: tribes[id].Color}}></i>{tribes[id].TribeName}<br/></div>)
                })}
